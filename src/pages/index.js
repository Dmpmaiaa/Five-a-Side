...
export default function Home() {
  ...
  return (
    <div className="h-screen w-screen flex flex-col  items-center gap-16 justify-center pb-24 bg-gradient-to-b from-primaryDarkestBlue from-5% to-primaryDarkerBlue">
